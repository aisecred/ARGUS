...
python3 domain_osint.py -h > /dev/null 2>&1 && echo "✓ Installation successful!" || echo "❌ Installation failed"
...
echo "   python3 domain_osint.py -d example.com --preset passive"
echo ""
echo "2. Active scan with HTTP probing:"
echo "   python3 domain_osint.py -d example.com --preset active"
echo ""
echo "3. Using a config file:"
echo "   python3 domain_osint.py --config config.yaml -d example.com"
echo ""
echo "4. Query existing results:"
echo "   python3 domain_osint.py --query -o recon_results/example/"
echo ""
echo "For full options, run: python3 domain_osint.py --help"
echo ""
